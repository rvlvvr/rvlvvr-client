...
(function(){
  ...
  var drawFavicon = function(label, colour0) {
    ...
    faviconImage.onload = function() {
      ...
      if ((label + '').length > 0) {
        drawBubble(context, label, colour);
      }
  ...
  var drawBubble = function(context, label, colour) {
    ...
    // label
    context.fillStyle = colour || options.colour;
